...
const provider=popoverContentNode.closest('.mud-popover-provider');if(provider){const parent=provider.parentElement;if(parent){const overlay=parent.querySelector('.mud-overlay');if(overlay){if(!overlay.style['z-index']){overlay.style['z-index']=popoverContentNode.style['z-index'];}}}}}
